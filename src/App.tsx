...
export default function App() {
  return <Routes>
    ...
    <Route element={<ProtectedRoute />}><Route element={<ApplicationLayout />}><Route path="/hoy" element={<TodayPage />} /><Route path="/historial" element={<HistoryPage />} /><Route path="/estadisticas" element={<StatisticsPage />} /><Route path="/ajustes" element={<PlaceholderPage title="Ajustes" description="Aquí configurarás tu perfil y recordatorios." />} /></Route></Route>
